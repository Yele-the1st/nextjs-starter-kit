  ...
  return (
    <div className="flex flex-col items-center justify-center leading-6">
      ...
      <p className="mx-auto max-w-[700px] text-gray-500 md:text-lg text-center mt-2 dark:text-gray-400">
        Everything you need to quickly build your SaaS, AI product, or any other
        web application fast giving you time to focus on what really matters
      </p>
      <div className="flex justify-center items-center gap-3">
        ...
        <Link
          href="https://discord.gg/H4jhzSfP"
          target="_blank"
          className="mt-5"
        >
          <Button
        ...
        <Link
          href="https://github.com/Yele-the1st/nextjs-starter-kit"
          target="_blank"
